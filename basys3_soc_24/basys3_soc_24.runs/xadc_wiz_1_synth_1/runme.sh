...
HD_PWD='C:/JAEWOO_SoC/Vivado_2019/basys3_soc_24/basys3_soc_24.runs/xadc_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_wiz_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_wiz_1.tcl
