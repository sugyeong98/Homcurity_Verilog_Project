...
--               c:/JAEWOO_SoC/Vivado_2019/basys3_soc_24/basys3_soc_24.srcs/sources_1/ip/xadc_wiz_1/xadc_wiz_1_sim_netlist.vhdl
-- Design      : xadc_wiz_1
...
inst: unisim.vcomponents.XADC
    generic map(
      ...
      RESET => reset_in,
      VAUXN(15) => vauxn15,
      VAUXN(14 downto 7) => B"00000000",
      VAUXN(6) => vauxn6,
      VAUXN(5 downto 0) => B"000000",
      VAUXP(15) => vauxp15,
      VAUXP(14 downto 7) => B"00000000",
      VAUXP(6) => vauxp6,
